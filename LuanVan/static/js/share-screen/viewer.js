export default class viewer {
    ...
    constructor(options = {}) {
        ...
        this.player = options.videoElement;
        ...
        this.autoPlay = true;
        this.idView = options.idView;
        this.videoElement = options.videoElement;
        this.pathSocketIO = options.pathSocketIO;
    ...
    async init() {
        ...
        script.setAttribute("src", this.pathSocketIO);
        script.onload = () => {
    ...
    registerNodeEvents() {
        let sessionId = this.idView;
        this.socket = io.connect(this.serverSocket, {query: "mobile=" + this.mobileCheck() + "&session_id=" + sessionId});
